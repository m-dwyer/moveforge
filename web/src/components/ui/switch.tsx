...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    className={cn(
      ...
      "data-[state=checked]:bg-accent data-[state=unchecked]:bg-panel-2",
      className
    )}
    {...props}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        "pointer-events-none block h-4 w-4 rounded-full bg-text shadow-lg ring-0 transition-transform",
