...
const PARAMS = [
    { key: "time", name: "Time", min: 0, max: 1, step: 0.01, dec: 2, def: 0.3 },
    { key: "sync", name: "Sync", min: 0, max: 9, step: 1, dec: 0, def: 0 },
    { key: "feedback", name: "Feedback", min: 0, max: 0.95, step: 0.01, dec: 2, def: 0.45 },
    ...
    { key: "space", name: "Space", min: 0, max: 1, step: 0.01, dec: 2, def: 0.25 },
    { key: "mix", name: "Mix", min: 0, max: 1, step: 0.01, dec: 2, def: 0.35 }
];
