/*
 * Swarf Chain UI — GENERATED by scripts/gen-ui-chain.ts from module.json.
...
const PARAMS = [
    { key: "hat_tune", name: "Hat Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 84 },
    { key: "hat_decay", name: "Hat Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.329 },
    { key: "hat_mat", name: "Hat Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 0.92 },
    { key: "hat_body", name: "Hat Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.7 },
    { key: "hat_tone", name: "Hat Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.55 },
    { key: "hat_strike", name: "Hat Strike", min: 0, max: 1, step: 0.01, dec: 2, def: 0.5 },
    { key: "hat_grit", name: "Hat Grit", min: 0, max: 1, step: 0.01, dec: 2, def: 0.3 },
    { key: "hat_level", name: "Hat Level", min: 0, max: 1, step: 0.01, dec: 2, def: 0.73 },
    { key: "oh_tune", name: "OpenHat Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 88 },
    { key: "oh_decay", name: "OpenHat Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.663 },
    { key: "oh_mat", name: "OpenHat Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 1 },
    { key: "oh_body", name: "OpenHat Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.7 },
    { key: "oh_tone", name: "OpenHat Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.55 },
    { key: "oh_strike", name: "OpenHat Strike", min: 0, max: 1, step: 0.01, dec: 2, def: 0.44 },
    { key: "oh_grit", name: "OpenHat Grit", min: 0, max: 1, step: 0.01, dec: 2, def: 0.26 },
    { key: "oh_level", name: "OpenHat Level", min: 0, max: 1, step: 0.01, dec: 2, def: 0.5 },
    { key: "ride_tune", name: "Ride Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 74 },
    { key: "ride_decay", name: "Ride Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.924 },
    { key: "ride_mat", name: "Ride Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 0.95 },
    { key: "ride_body", name: "Ride Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.8 },
    { key: "ride_tone", name: "Ride Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.52 },
    { key: "ride_strike", name: "Ride Strike", min: 0, max: 1, step: 0.01, dec: 2, def: 0.4 },
    { key: "ride_grit", name: "Ride Grit", min: 0, max: 1, step: 0.01, dec: 2, def: 0.18 },
    { key: "ride_level", name: "Ride Level", min: 0, max: 1, step: 0.01, dec: 2, def: 0.34 },
    { key: "clap_tune", name: "Clap Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 68 },
    { key: "clap_decay", name: "Clap Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.566 },
    { key: "clap_mat", name: "Clap Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 0.92 },
    { key: "clap_body", name: "Clap Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.65 },
    { key: "clap_tone", name: "Clap Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.5 },
    { key: "clap_strike", name: "Clap Strike", min: 0, max: 1, step: 0.01, dec: 2, def: 0.86 },
    { key: "clap_grit", name: "Clap Grit", min: 0, max: 1, step: 0.01, dec: 2, def: 0.34 },
    { key: "clap_level", name: "Clap Level", min: 0, max: 1, step: 0.01, dec: 2, def: 0.48 },
    { key: "conga_tune", name: "Conga Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 58 },
    { key: "conga_decay", name: "Conga Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.631 },
    { key: "conga_mat", name: "Conga Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 0.5 },
    { key: "conga_body", name: "Conga Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.72 },
    { key: "conga_tone", name: "Conga Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.42 },
    { key: "conga_strike", name: "Conga Strike", min: 0, max: 1, step: 0.01, dec: 2, def: 0.52 },
    { key: "conga_grit", name: "Conga Grit", min: 0, max: 1, step: 0.01, dec: 2, def: 0.22 },
    { key: "conga_level", name: "Conga Level", min: 0, max: 1, step: 0.01, dec: 2, def: 0.62 },
    { key: "wood_tune", name: "Wood Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 71 },
    { key: "wood_decay", name: "Wood Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.448 },
    { key: "wood_mat", name: "Wood Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 0.04 },
    { key: "wood_body", name: "Wood Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.66 },
    { key: "wood_tone", name: "Wood Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.48 },
    { key: "wood_strike", name: "Wood Strike", min: 0, max: 1, step: 0.01, dec: 2, def: 0.54 },
    { key: "wood_grit", name: "Wood Grit", min: 0, max: 1, step: 0.01, dec: 2, def: 0.2 },
    { key: "wood_level", name: "Wood Level", min: 0, max: 1, step: 0.01, dec: 2, def: 0.35 },
    { key: "volume", name: "Volume", min: 0, max: 1, step: 0.01, dec: 2, def: 0.75 },
    { key: "drive", name: "Drive", min: 0, max: 1, step: 0.01, dec: 2, def: 0.18 },
    { key: "curve", name: "Curve", min: 0, max: 4, step: 1, dec: 0, def: 0 },
    { key: "tone", name: "Bus Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.5 },
    { key: "shape", name: "Shape", min: 0, max: 1, step: 0.01, dec: 2, def: 0.3 },
    { key: "human", name: "Human", min: 0, max: 1, step: 0.01, dec: 2, def: 0.25 },
    { key: "vel_depth", name: "Vel Depth", min: 0, max: 1, step: 0.01, dec: 2, def: 0.6 },
    { key: "spread", name: "Spread", min: 0, max: 1, step: 0.01, dec: 2, def: 0.4 },
    { key: "root", name: "Root", min: 0, max: 96, step: 1, dec: 0, def: 36 },
    { key: "chrom", name: "Chrom", min: 0, max: 6, step: 1, dec: 0, def: 0 },
    { key: "choke", name: "Choke", min: 0, max: 2, step: 1, dec: 0, def: 1 },
    { key: "kit_decay", name: "Kit Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.5 },
    { key: "bright", name: "Bright", min: 0, max: 1, step: 0.01, dec: 2, def: 0.5 },
    { key: "warp", name: "Warp", min: 0, max: 1, step: 0.01, dec: 2, def: 0.5 }
];
