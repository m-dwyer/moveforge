...
const PARAMS = [
    { key: "hat_tune", name: "Hat Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 88 },
    { key: "hat_decay", name: "Hat Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.329 },
    { key: "hat_mat", name: "Hat Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 0.75 },
    { key: "hat_body", name: "Hat Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.1 },
    { key: "hat_tone", name: "Hat Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.68 },
    ...
    { key: "oh_tune", name: "OpenHat Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 86 },
    { key: "oh_decay", name: "OpenHat Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.663 },
    { key: "oh_mat", name: "OpenHat Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 0.75 },
    { key: "oh_body", name: "OpenHat Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.12 },
    { key: "oh_tone", name: "OpenHat Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.66 },
    ...
    { key: "ride_tune", name: "Ride Tune", min: 24, max: 108, step: 0.84, dec: 1, def: 79 },
    { key: "ride_decay", name: "Ride Decay", min: 0, max: 1, step: 0.01, dec: 2, def: 0.924 },
    { key: "ride_mat", name: "Ride Mat", min: 0, max: 1, step: 0.01, dec: 2, def: 1 },
    { key: "ride_body", name: "Ride Body", min: 0, max: 1, step: 0.01, dec: 2, def: 0.18 },
    { key: "ride_tone", name: "Ride Tone", min: 0, max: 1, step: 0.01, dec: 2, def: 0.62 },
