...
src/modules/<id>/
  ...
  ui_chain.js
  dsp/
    <id>_core.h            ← state struct + public API
    <id>_core.c            ← DSP (hand-written)
...
src/modules/<id>/
  ...
  dsp/
    ...
    <id>_core.h            ← adapter header
    <id>_core.c            ← thin adapter: captures Faust param zones, drives compute()
