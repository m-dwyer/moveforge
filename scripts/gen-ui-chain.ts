 ...
 * the jog wheel scrolls/selects/edits one focused param, and Knob 1..8
 * adjust the page containing the selected param. Param metadata is taken
 * from module.json so it never drifts.
 *
 ...
 * in a chain slot. Knob 1..${ENCODER_COUNT} adjust the page containing the
